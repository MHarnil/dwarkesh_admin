...
import PropertyTypesList from "./components/Property/propertyTypesList.jsx";
    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path="/property" element={<PropertyTypesList/>}/>
                <Route path="/property-form" element={<PropertyForm/>}/>
                <Route path="/property-form/:id" element={<PropertyForm/>}/>
            </Routes>
        </>
    );
}
